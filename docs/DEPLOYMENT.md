...
| Installer lifecycle operations | Supported baseline for local asset update, runtime backup/restore, scheduled local backup, encrypted remote backup archives and guarded uninstall. Remote release update and full automated resume remain future work. |
