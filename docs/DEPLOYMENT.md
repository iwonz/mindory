...
| Installer lifecycle operations | Supported baseline for local asset update, runtime backup/restore, scheduled local backup and guarded uninstall. Remote release update and full automated resume remain future work. |
