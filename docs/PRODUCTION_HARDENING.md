...
| Installer execution | Partial baseline. Current installer can prepare `$MINDORY_HOME`, start Compose through health checks, provision the first token and roll back startup failures, but update and uninstall are future work. |
